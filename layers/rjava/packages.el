...
(defun rjava/post-init-company ()
  (add-hook 'java-mode-local-vars-hook #'spacemacs//java-setup-company))

(defun rjava/init-company-emacs-eclim ()
...
(defun rjava/init-maven-test-mode ()
